...
document_sw_model = api.clone('Document', record_monitoring_sw_model, {
    'created_by': fields.Nested(creator_sw_model),
    'name': fields.String(description='Document name with file extension.',
                          example='document.pdf'),
    'mime_type': fields.String(readonly=True, example='application/pdf'),
    'size': fields.Integer(readonly=True,
                           description='File size in bytes.', example=6000000),
    'url': fields.String(readonly=True,
                         description='URL for getting the document content.'),
})
